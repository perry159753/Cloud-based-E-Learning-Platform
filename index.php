...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		<div class="item">
			<div class="fill" style="background-image:url('images/certificate.jpg');"></div>
		</div>
		<div class="item active">
			<div class="fill" style="background-image:url('images/e-learning.jpg');"></div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('images/assessment.jpg');"></div>
            </div>
        </div>
        <!-- Controls -->
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
                    Welcome to DJYU's - A Cloud based E-Learning Platform
                </h1>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The DJYU's E-Learning Platform is useful for the
							students, faculties, guests whomever likes to learn from web using E-Learn
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4><i class="fa fa-fw fa-code"></i> Developers</h4>
				</div>
				<div class="panel-body">
					<p>
					<ul style="list-style-type:disc">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">EXCEL IN VARIOUS TECHNOLOGIES</h2>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">DJYU's - A Cloud based E-Learning Platform</h2>
		</div>
		<div class="col-md-6">
			<p>The CLOUD COMPUTING MINI PROJECT by:</p>
			<p><strong>PARTH SHAH  60004188021</strong></p>
			<p><strong>HET RAVAL   60004188014</strong></p>
			<p><strong>VIRAJ SHAH  60004170121</strong></p>
			<p><strong>YASH SHAH   60004170126</strong></p>	
		</div>
		<div class="col-md-6">
