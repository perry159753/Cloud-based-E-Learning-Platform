	...
	<div class="row">
		<div class="col-md-4">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					<label for="Father Name">Channel Name :<span style="color: #ff0000;">*</span></label>
					<input type="text" class="form-control" id="chname" name="chname" required>
				</div>
			...
			if ( isset( $_POST[ 'addnewfaculty' ] ) ) {
				...
				$temppass = $_POST[ 'pass' ];
				// adding new faculty
				$sql = "insert facutlytable (FName, ChName, Addrs, Gender, JDate, City, Pass, PhNo) values ('$tempfname', '$tempchname', '$tempaddrs','$tempgender', '$tempjdate', '$tempcity' , '$temppass','$tempphno')";
