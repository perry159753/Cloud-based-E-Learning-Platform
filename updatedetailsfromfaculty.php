	...
	<div class="row">
		<div class="col-md-5">
			...
			<h3> Welcome Faculty : <a href="welcomefaculty.php"><span style="color:#FF0004"> <?php echo $fname; ?></span></a></h3>
				...
				<div class="form-group">
				Channel Name : <input type="text" name="chname" value="<?PHP echo $row['ChName'];?>"><br></div>
				<div class="form-group">
		...
		if(isset($_POST['update']))		
			{
				...
				$sql="UPDATE `facutlytable` SET FName='$tempfname',ChName='$tempchname',Addrs='$tempaddrs', Gender='$tempgender', City='$tempcity',Pass='$temppass', PhNo=$tempphno WHERE FID=$new2"; 
